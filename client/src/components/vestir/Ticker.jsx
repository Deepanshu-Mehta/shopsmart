export default function Ticker() {
  const text = (
    <>
      NEW ARRIVALS <span style={{ color: 'var(--color-accent)', margin: '0 16px' }}>—</span>{' '}
      SS25 <span style={{ color: 'var(--color-accent)', margin: '0 16px' }}>—</span>{' '}
      FREE SHIPPING OVER ₹5,000 <span style={{ color: 'var(--color-accent)', margin: '0 16px' }}>—</span>{' '}
      NEW ARRIVALS <span style={{ color: 'var(--color-accent)', margin: '0 16px' }}>—</span>{' '}
      SS25 <span style={{ color: 'var(--color-accent)', margin: '0 16px' }}>—</span>{' '}
      FREE SHIPPING OVER ₹5,000 <span style={{ color: 'var(--color-accent)', margin: '0 16px' }}>—</span>{' '}
    </>
